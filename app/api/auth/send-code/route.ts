      ...
      <body style="margin: 0; padding: 0; font-family: 'Solena-Regular', 'Poppins', 'Arial', sans-serif; background-color: #ffffff;">
        <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
          ...
          <div style="background-color: #333; padding: 40px 30px; text-align: center;">
            <h1 style="color: #ffffff; font-size: 28px; font-weight: 400; margin: 0; letter-spacing: 2px; font-family: 'Solena-Regular', 'Times New Roman', 'Georgia', serif;">AMBELIE</h1>
            <p style="color: #ffffff; font-size: 14px; margin: 8px 0 0 0; opacity: 0.8; letter-spacing: 1px; font-family: 'Poppins', 'Arial', sans-serif; font-weight: 300;">EMAIL VERIFICATION</p>
          </div>
          ...
          <!-- Email Signature -->
          <div style="margin-top: 30px; padding: 25px; background-color: #f8f8f8; border-radius: 8px; border-top: 2px solid #333;">
